    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                <h2><i class="fa fa-list-alt bg-orange"></i> Edit Article <small
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            @if($errors->any())
                                ...
                                @endforeach
                            @endif
                            <form class="form-wrapper" action="{{ route('updateArticle', $article->id) }}" method="POST"
                                ...
                                <textarea class="ckeditor" cols="200" id="editor1" name="article"
                                          rows="60">{{ $article->content }}</textarea>
